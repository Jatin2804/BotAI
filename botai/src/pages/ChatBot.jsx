...
import { response } from "../Response/ChatBot.response";
...
const ChatBot = ({ savedChats, setSavedChats }) => {
  ...
  const handleSave = () => {
    ...
    setSavedChats((prevChats) => {
      const updatedChats = [
        { model: "ChatBot", date: now, chats: messages, feedback: feedback },
        ...prevChats,
      ];
